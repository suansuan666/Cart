...
export default {
  ...
  methods: {
    ...
    regist(salt) {
      console.log(salt);
      let passMd5 = this.getMD5(this.registPassword.trim());
      this.registPassword = this.getMD5(passMd5 + salt);
      axios({
        url: url.registUser,
        method: "post",
        data: {
    ...
    login(salt) {
      console.log(salt);
      let passMd5 = this.getMD5(this.loginPassword.trim());
      this.loginPassword = this.getMD5(passMd5 + salt);
      axios({
        url: url.loginUser,
        method: "post",
        data: {
        ...
        .then(res => {
          ...
          if (res.data.code == 200) {
            ...
            this.$toast("登录成功"), this.$router.push("/");
          }
